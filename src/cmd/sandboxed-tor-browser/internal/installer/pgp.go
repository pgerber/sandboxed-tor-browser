...
const (
	// gpg --export-options export-minimal --armor --export 0x4E2C6E8793298290
	//
	// pub   rsa4096/0x4E2C6E8793298290 2014-12-15 [C] [expires: 2020-08-24]
	// uid                   [ unknown] Tor Browser Developers (signing key) <torbrowser@torproject.org>
	// sub   rsa4096/0x7017ADCEF65C2036 2014-12-15 [S] [expires: 2017-08-25]
	// sub   rsa4096/0x2E1AC68ED40814E0 2014-12-15 [S] [expires: 2017-08-25]
	// sub   rsa4096/0xD1483FA6C3C07136 2016-08-24 [S] [expires: 2018-08-24]
	tbbSigningKeyID = 0x4E2C6E8793298290

	tbbSigningKeyPEM = `-----BEGIN PGP PUBLIC KEY BLOCK-----
...
func init() {
	...
	buf := bytes.NewReader([]byte(tbbSigningKeyPEM))
